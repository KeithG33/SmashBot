...
DATA_DIR_TRAIN = '/home/kage/smashbot_workspace/dataset/hickle_sequence/train'
DATA_DIR_TEST = '/home/kage/smashbot_workspace/dataset/hickle_sequence/test'

DATASET_SIZE_TRAIN = 17
DATASET_SIZE_TEST = 2
DATASET_PROCESSES = 1
...
MODEL_SAVEPATH = 'SmashBotTransformer-seq_fix.pt'
...
def training_round(model, train_loader, optimizer, scheduler, grad_scaler, num_epochs=10, log_every=1000, validation_every=20_000):
    best_val_loss = 1000
...
def run_training(num_rounds, model):
    ...
    scheduler = WarmupLR(scheduler=scheduler, init_lr=6e-5, num_warmup=5_000, warmup_strategy='cos')
...
if __name__ == "__main__":
    model = SmashTransformer(action_dim=10, embed_dim=120, model_dim=384, nhead=24, num_layers=5, dropout=0.0)
    ...
    wandb.init(project="smashbot", id='0a5yzy06', resume='must')
